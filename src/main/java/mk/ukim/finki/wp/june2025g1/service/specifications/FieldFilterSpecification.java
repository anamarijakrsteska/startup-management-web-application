...
public class FieldFilterSpecification {
    ...
    public static <T> Specification<T> filterEquals(Class<Startup> clazz, String field, Long value) {
        if (value == null) {
            return null;
        }
    ...
    public static <T> Specification<T> filterEquals(Class<Startup> clazz, String field, Integer value) {
        if (value == null) {
            return null;
        }
        return (root, query, criteriaBuilder) -> criteriaBuilder.equal(fieldToPath(field, root), value);
    ...
    public static <T> Specification<T> filterEquals(Class<Startup> clazz, String field, Double value) {
        if (value == null) {
            return null;
        }
        return (root, query, criteriaBuilder) -> criteriaBuilder.equal(fieldToPath(field, root), value);

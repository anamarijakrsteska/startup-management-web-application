...
public class StartupController {
    ...
    public String showAdd(Model model) {
        //name, valuation, yearFounded, industry, founderId
        model.addAttribute("industry", Industry.values());
        model.addAttribute("founders", founderService.listAll());
        return "form";
    }
    ...
    public String create(@RequestParam String name, @RequestParam Double valuation, @RequestParam Integer yearFounded, @RequestParam Industry industry, @RequestParam Long founderId) {
    ...
    public String update(@PathVariable Long id, @RequestParam String name, @RequestParam Double valuation, @RequestParam Integer yearFounded, @RequestParam Industry industry, @RequestParam Long founderId) {
